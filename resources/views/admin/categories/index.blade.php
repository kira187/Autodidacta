                ...
                <div class="card-header border-bottom p-1">
                    ...
                    <div class="dt-action-buttons text-right">
                        <div class="dt-buttons d-inline-flex"> 
                            <a class="dt-button create-new btn btn-primary btn-sm" href="{{ route('admin.categories.create') }}"><i data-feather="plus"></i> Crear Categoria</a>
                        </div>
                    </div>
                </div>
                
                <div class="card-body">
                    <table class="dt-responsive table table-hover" id="categories">
                        <thead>
                            <tr>
