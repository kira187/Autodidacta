...
<div class="container py-10">
    <div class="grid grid-cols-3 min-w-full border rounded" style="min-height: 60vh;">
            <div class="col-span-1 bg-white border-r border-gray-300">
                ...
                <ul class="overflow-auto" style="height: 300px;">
            ...
            <div class="col-span-2 bg-white">
                <div class="w-full">
                    ...
                    <div id="chat" class="w-full overflow-y-auto p-10 relative" style="height: 500px;" ref="toolbarChat">
                        <ul>
                            <li class="clearfix2">
