                ...
                <div class="container py-10 lg:py-6">
                    <div class="grid gird-rows-1 grid-cols-1 md:grid-cols-3 xl:grid-cols-2">
                        ...
                        <div class="pr-0 xl:pr-28 text-center  md:text-right col-span-1 sm:col-span-2 xl:col-span-1">
                            <a href="" class=" mb-4 md:mb-0 inline-block hover:text-gray-700 inline-block text-white mr-0 sm:mr-10"><p>Politicas de privacidad</p></a>
                            <a href="" class=" mb-4 md:mb-0 inline-block hover:text-gray-700 inline-block text-white"><p>Terminos y condiciones</p></a>
                        </div>
                    </div>
                </div>
            </section>
