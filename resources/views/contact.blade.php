<x-app-layout>
    <div class="px-8">
        <div class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900">
            <div class="flex flex-col justify-between">
                <div>
                    <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Ponte en contácto</h2>
                    <div class="text-gray-700 mt-8">
                        Si deseas, también puedes escribirnos a nuestro <span class="underline">correo electrónico</span>.
                    </div>
                </div>
            ...
            <div class="">
                ...
                <div class="mt-8">
                    <span class="uppercase text-sm text-gray-600 font-bold">Correo electronico</span>
                    <input class="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text">
                </div>
                <div class="mt-8">
                ...
                <div class="mt-8">
                    <button
                    class="uppercase text-sm font-bold tracking-wide bg-blue-500 hover:bg-blue-700 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                    Enviar Mensaje
                    </button>
                </div>
            </div>
