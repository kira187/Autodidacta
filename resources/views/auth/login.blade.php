    ...
    <x-authentication-card>
        ...
        <div class="pt-2">
            <div class="flex items-center mt-6 -mx-2">
                <a href="{{ url('login/google')}} " class="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
                ...
                <a href="{{ url('login/facebook') }}" class="p-2 mx-2 text-sm font-medium text-gray-500 transition-colors duration-200 transform bg-gray-300 rounded-md hover:bg-gray-200"> <i class="fab fa-facebook-square fa-lg"></i></a>
            </div>
        </div>
